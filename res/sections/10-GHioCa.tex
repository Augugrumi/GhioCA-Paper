...
based on the fact that a certain word could be more or less correlated to the 
picture. In that case, we present to the user only the more related results.

This layer not only has responsibility to search the image but it has to offer
