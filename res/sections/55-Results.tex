...
The final number of photos that we received is 146.
...
counted them and, thanks to \texttt{R}, we built several graphical 
...
In this case, we obtain a perfect match. However, with different resolutions and 
languages, the results are not so good. Unfortunately, we were not able to gain 
data to build a good evaluation set.