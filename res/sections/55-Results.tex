...
correctly addressed. In order to achieve this, we distributed GHio-Ca to 30 
...
\caption{Histogram of Azure tagging results (708 tags provided)}
...
\caption{Histogram of Google tagging results (32 tags provided)}
...
\caption{Histogram of Imagga tagging results (520 tags provided)}
...
\caption{Histogram of Watson tagging results (841 tags provided)}
...
were not able to gain enough data to build a good evaluation set.